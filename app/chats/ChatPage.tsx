...
const ChatPage: React.FC = () => {
	...
	return (
		<div className="flex flex-col h-screen bg-gray-100">
			<div className="flex-grow flex flex-col justify-between bg-white shadow-md rounded-t-lg overflow-hidden">
				<div
				...
				>
					{messages.map((msg, idx) => (
						<div
							key={idx}
							className={`p-3 my-2 rounded-md max-w-xs ${idx % 2 === 0 ? "bg-blue-500 text-white self-start" : "bg-gray-300 self-end"}`}
						>
							{msg}
						</div>
					))}
